// Sample program demonstrating when implicit interface conversions are
...
// Move can change the positio of a bike
func (b *bike) Move() {
	fmt.Println("Moving the bike")
}

// Lock prevent a bike from moving
func (b *bike) Lock() {
	fmt.Println("Locking the bike")
}

// Unlock allows the bike to be moved
func (b *bike) Unlock() {
