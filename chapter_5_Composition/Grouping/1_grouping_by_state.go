...
func main() {
	...
	/*
	   ./1_grouping_by_state.go:67:6: cannot use Dog literal (type Dog) as type Animal in array or slice literal
	   ./1_grouping_by_state.go:77:6: cannot use Cat literal (type Cat) as type Animal in array or slice literal
	*/
